...
var CTASController = function ($scope, $state, $q, $mdDialog, $timeout, ProcessorService, details, databases) {
...
CTASController.$inject = ['$scope', '$state', '$q', '$mdDialog', '$timeout', 'ProcessorService', 'details', 'databases'];
angular.module('meltStandardUI').controller('CTASController', CTASController);
