        ...
        <div id="update-attributes-content">
            <div id="rule-list-panel">
                <div id="flowfile-policy-container">
                    ...
                    <div id="flowfile-policy-label" class="large-label">Select Database</div>
                ...
                <div id="no-rules" class="unset">No tables found.</div>
            ...
            <div id="rule-details-panel">
                <div id="selected-rule-conditions-container" class="selected-rule-detail">
                    <div class="large-label-container">
                        <div id="conditions-label" class="large-label">SQL File</div>
                        <div class="info fa fa-question-circle" title="All conditions must be met for this rule to match."></div>
                        <button id="save-condition" title="Save SQL File" class="new-condition hidden fa fa-save"></button>
                        <button id="new-condition" title="New SQL tab" class="new-condition hidden fa fa-plus"></button>
                        <div class="clear"></div>
                    </div>
